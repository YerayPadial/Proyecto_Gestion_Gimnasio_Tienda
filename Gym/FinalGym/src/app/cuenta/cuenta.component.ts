      ...
      switch (response.rol) {
        case 'worker':
          ...
          setTimeout(() => {
            ...
            window.location.href = 'https://padiyera.ososportgym.es/finalgym-api/admin/login';
          }, 1000);
        ...
        case 'cliente':
          ...
          if (this.cliente) {
            ...
            if (this.cliente.foto && this.cliente.foto !== 'null' && this.cliente.foto !== 'undefined') {
             this.cliente.foto = 'https://padiyera.ososportgym.es/finalgym-api/storage/' + this.cliente.foto;//rutax
            } else {
